...
export class AddBundleProductComponent implements OnInit {
    ...
    getProducts() {
        this.productsService.listProduct().subscribe(
            (res: any) => {
        ...
        if (this.selectedBundleProduct) {
            ...
            this.bundleProductsService
                .updateBundleProducts(
                    ...
                    this.addBundleProductsForm.value
                )
                .subscribe(
                    (res: any) => {
            ...
            this.bundleProductsService
                .addBundleProducts(this.addBundleProductsForm.value)
                .subscribe(
                    (res: any) => {
                        this.addBundleProductsForm.reset();
                        this.tags = [];
    ...
    removeImage(e: any) {
        ...
        if (confirm("Are you sure to delete ?")) {
            this.bundleProductsService.removeImage(removeImageData).subscribe(
                (response: any) => {
