...
export class CustmorGroupsComponent implements OnInit {
 @ViewChild('content') content: any;
    ...
    getData() {
        this.brandsService
            .getBrands({ params: this.tablePaging })
            .subscribe((res: any) => {
                this.loading = false;
    ...
    getNextData() {
        ...
        this.userDataPromise = this.brandsService
            .getBrands({ params: this.tablePaging })
    ...
    postFormInput() {
        ...
        if (this.selectedBrand) {
            ...
            this.brandsService
                .updateBrands(this.selectedBrand, this.brandsForm.value)
                .subscribe(
                    (results: any) => {
    ...
    postData() {
        ...
        if (this.showPreview === true) {
            ...
            if (
                ...
                this.brandsService.uploadBrandBanner(formData).subscribe(
                    (res: any) => {
    ...
    deleteBrand(deleteBrand: any) {
        if (confirm('Are you sure to delete ?')) {
            this.brandsService
                .deleteBrands(deleteBrand._id, deleteBrand)
                .subscribe((res: any) => {
                    this.getNextData();
                });
        }
